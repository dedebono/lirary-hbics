...
const BookCSVImport = ({ onImportComplete }) => {
    ...
    const handleImport = async () => {
        ...
        try {
            const response = await api.post('/import/import-books', formData, {
                headers: {
    ...
    const downloadTemplate = () => {
        const csvContent = 'book_barcode,book_name,author,publisher,year,quantity,book_isbn\nBOOK001,The Great Gatsby,F. Scott Fitzgerald,Scribner,1925,5,9780743273565\nBOOK002,To Kill a Mockingbird,Harper Lee,J.B. Lippincott & Co.,1960,3,9780061120084';
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xl font-bold">Import Books from CSV</h3>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-600 mb-2">
                                CSV Format: book_barcode, book_name, author, publisher, year, quantity, book_isbn
                            </p>
                            <p className="text-xs text-gray-500">
                                Required fields: book_barcode, book_name, quantity
                            </p>
                            <p className="text-xs text-gray-500">
                                Optional fields: author, publisher, year, book_isbn
                            </p>
                        </div>
